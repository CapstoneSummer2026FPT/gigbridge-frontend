  ...
  it('allows funding when the wallet exactly covers escrow and fee', async () => {
    ...
    vi.mocked(walletGetAPI.getMyWallet).mockResolvedValue({
      ...
      data: {
        walletId: 'wallet-1',
        userId: 'client-1',
        depositedGigCoin: 1_010,
        withdrawableGigCoin: 0,
        heldGigCoin: 0,
        pendingWithdrawalGigCoin: 0,
        totalSpendableGigCoin: 1_010,
        depositedGigCoinVnd: 1_010_000,
        withdrawableGigCoinVnd: 0,
        heldGigCoinVnd: 0,
        pendingWithdrawalGigCoinVnd: 0,
        totalSpendableGigCoinVnd: 1_010_000,
      },
    });
  ...
  it('shows the precise shortfall and does not call funding when balance is insufficient', async () => {
    vi.mocked(walletGetAPI.getMyWallet).mockResolvedValue({
      ...
      data: {
        walletId: 'wallet-1',
        userId: 'client-1',
        depositedGigCoin: 1_009.9999,
        withdrawableGigCoin: 0,
        heldGigCoin: 0,
        pendingWithdrawalGigCoin: 0,
        totalSpendableGigCoin: 1_009.9999,
        depositedGigCoinVnd: 1_009_999.9,
        withdrawableGigCoinVnd: 0,
        heldGigCoinVnd: 0,
        pendingWithdrawalGigCoinVnd: 0,
        totalSpendableGigCoinVnd: 1_009_999.9,
      },
    });
