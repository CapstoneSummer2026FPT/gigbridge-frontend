...
import {
  ...
  Upload, Link2, X, AlertCircle, Loader2, Wallet, MessageSquare
} from 'lucide-react';
      ...
      <div className="project-workspace-page flex flex-col h-[calc(100vh-5rem)] pt-4 bg-background text-foreground overflow-hidden">
        ...
        <div className="flex lg:hidden p-1 bg-muted/60 dark:bg-muted/40 backdrop-blur-md rounded-2xl border border-border shrink-0 shadow-2xs gap-1">
          ...
          >
            ...
            <span className="truncate">{t('workspace.milestones')}</span>
          </button>
          <button
          ...
          >
            ...
            <span className="truncate">{t('workspace.chatFiles')}</span>
          </button>
        </div>
