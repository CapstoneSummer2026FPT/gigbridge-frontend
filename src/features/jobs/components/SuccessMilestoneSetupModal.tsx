...
export function SuccessMilestoneSetupModal({
  isOpen,
  onClose,
  onSetup,
  onInvite,
}: SuccessMilestoneSetupModalProps) {
      ...
      <div className="bg-card border border-border rounded-2xl p-8 max-w-md w-full shadow-2xl flex flex-col items-center text-center gap-6 relative animate-[fadeIn_0.2s_ease-out]">
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Your job post signature is saved. Milestones are still a draft and can be set up now or later from My Jobs.
          </p>
        </div>
