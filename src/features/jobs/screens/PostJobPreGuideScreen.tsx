      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 relative">
        ...
        <div className="bg-card border border-border rounded-2xl p-6 sm:p-8 shadow-sm">
          <h3 className="text-lg font-bold text-foreground border-b border-border pb-4 mb-6 flex items-center gap-2">
            ...
            Cẩm nang tạo Project Request hiệu quả
          </h3>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  ...
                  Hãy mô tả chi tiết phần <strong className="text-foreground">Requirement Details</strong> về mục tiêu, bối cảnh, ràng buộc, dữ liệu đầu vào và deliverable mong muốn.
                  Milestone/payment plan sẽ do freelancer đề xuất trong proposal ở bước sau.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start">
              ...
              <div>
                <h4 className="text-sm font-bold text-foreground mb-1.5">2. Clarifying Questions là gì?</h4>
                <p className="text-xs text-muted-foreground leading-relaxed mb-3">
                  Đây là các câu hỏi không bắt buộc để freelancer làm rõ proposal, ví dụ assumption, dữ liệu còn thiếu hoặc yếu tố ảnh hưởng ngân sách.
                  Không dùng phần này như bài test hoặc phỏng vấn bắt buộc.
                </p>
