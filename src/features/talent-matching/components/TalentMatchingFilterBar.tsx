  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        {/* How Ranking Works Hover Tooltip (Only visible on smart matching tab) */}
        {activeStage === 'smart' && (
          <div className="relative group inline-flex items-center shrink-0">
            ...
            <div className="absolute right-0 top-full mt-2 hidden group-hover:block z-50 w-80 sm:w-84 rounded-2xl bg-surface border border-border text-text-primary p-4 text-xs shadow-2xl backdrop-blur-2xl opacity-100 text-left">
              <div className="font-bold text-text-primary flex items-center gap-2 mb-2 border-b border-border pb-2">
                <Sparkles size={16} className="text-brand shrink-0" />
                <span className="font-black text-sm text-text-primary">{t('talentMatching.howRankingWorksTitle')}</span>
              </div>
              <p className="text-xs text-text-secondary mb-3 leading-relaxed">{t('talentMatching.howRankingWorksSub')}</p>

              <div
                className="flex h-2.5 overflow-hidden rounded-full mb-3.5 bg-surface-muted border border-border/50"
                role="img"
                aria-label="Ranking weights"
              >
                <span className="bg-brand h-full transition-all" style={{ width: '45%' }} title="Skill match: 45%" />
                <span className="bg-purple-500 h-full transition-all" style={{ width: '35%' }} title="Track record: 35%" />
                <span className="bg-emerald-500 h-full transition-all" style={{ width: '20%' }} title="Activity: 20%" />
              </div>
              ...
              <div className="space-y-2.5">
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-0.5 text-[11px] text-text-secondary leading-snug">{t('talentMatching.factorSkillDesc')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-0.5 text-[11px] text-text-secondary leading-snug">{t('talentMatching.factorTrackDesc')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-0.5 text-[11px] text-text-secondary leading-snug">{t('talentMatching.factorActivityDesc')}</p>
                  </div>
                </div>
              </div>
