...
export const ADMIN_MANAGERS: readonly AdminManagerDefinition[] = [
  ...
  { id: 'withdrawals', labelKey: 'nav.withdrawals', fallbackLabel: 'Yêu Cầu Rút Tiền', descriptionKey: 'adminDashboard.descriptions.withdrawals', fallbackDescription: 'Review and reconcile withdrawal requests', path: '/admin/withdrawals', icon: Banknote, group: 'finance', showInNavigation: false, showOnDashboard: false },
  ...
  { id: 'elo', labelKey: 'adminElo.nav', fallbackLabel: 'Quản Lý Điểm Elo', descriptionKey: 'adminDashboard.descriptions.elo', fallbackDescription: 'Review Elo ledgers, resolve appeals, and configure dispute penalty', path: '/admin/elo', icon: Gauge, group: 'moderation', showInNavigation: false, showOnDashboard: false },
  { id: 'elo-appeals', labelKey: 'adminElo.navAppeals', fallbackLabel: 'Khiếu Nại Điểm Elo', descriptionKey: 'adminDashboard.descriptions.eloAppeals', fallbackDescription: 'Review and resolve Elo point appeals', path: '/admin/elo/appeals', icon: FileQuestion, group: 'moderation', showInNavigation: false, showOnDashboard: false, parentId: 'elo' },

  // 6. System Configuration
  { id: 'contract-templates', labelKey: 'nav.contractTemplates', fallbackLabel: 'Mẫu Hợp Đồng', descriptionKey: 'adminDashboard.descriptions.templates', fallbackDescription: 'Maintain reusable contract templates', path: '/admin/contract-templates', icon: Settings, group: 'configuration', showInNavigation: false, showOnDashboard: true },
