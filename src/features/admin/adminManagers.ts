...
export const ADMIN_MANAGERS: readonly AdminManagerDefinition[] = [
  ...
  { id: 'reports', labelKey: 'nav.reports', fallbackLabel: 'Reports', descriptionKey: 'adminDashboard.descriptions.reports', fallbackDescription: 'Review general content and account reports', path: '/admin/reports', icon: Flag, group: 'content', showInNavigation: true, showOnDashboard: true, parentId: 'reports' },
  { id: 'account-reports', labelKey: 'adminNav.accountReports', fallbackLabel: 'Account Reports', descriptionKey: 'adminDashboard.descriptions.accountReports', fallbackDescription: 'Investigate reports involving user accounts', path: '/admin/reports/accounts', icon: Users, group: 'content', showInNavigation: true, showOnDashboard: true, parentId: 'reports' },
