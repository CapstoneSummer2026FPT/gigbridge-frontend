          ...
          <div className="bam-form-grid">
            ...
            <div className="bam-field-group" ref={dropdownRef}>
              <label className="bam-field-label">
                <Building2 size={13} />
                <span>{t('wallet.bankAccount.bankLabel', { defaultValue: 'Ngân hàng' })}</span>
              </label>

              <div className="bam-custom-select-container">
                <Landmark size={16} className="bam-input-icon" />

                <button
                  type="button"
                  onClick={() => setBankDropdownOpen(!bankDropdownOpen)}
                  className={`bam-custom-select-trigger ${bankDropdownOpen ? 'is-open' : ''}`}
                >
                  <div className="bam-trigger-content">
                    {selectedBank ? (
                      <div className="flex items-center gap-2 min-w-0 truncate">
                        {selectedBank.shortName && (
                          <span className="bam-bank-short-badge">
                            {selectedBank.shortName}
                          </span>
                        )}
                ...
                {/* Popover Dropdown with GSAP Animation */}
                {bankDropdownOpen && (
                  <div ref={popoverRef} className="bam-select-popover">
                    {/* Search Input Box */}
                    <div className="bam-search-box">
                      <Search size={14} className="bam-search-icon" />
                      <input
                        type="text"
                        ...
                        filteredSupportedBanks.map(bank => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {isSelected && <Check size={14} className="text-[var(--brand,#494be7)] shrink-0" />}
                            </button>
                          );
                        })
                      ) : (
                        <div className="p-3 text-xs text-center text-[var(--text-muted,#95959f)] font-medium">
            ...
            <div className="bam-field-group">
              ...
              <div className="bam-input-wrapper">
                <User size={16} className="bam-input-icon" />
                <input
            ...
            <div className="bam-field-group">
              <label className="bam-field-label">
                <Hash size={13} />
                <span>{t('wallet.bankAccount.accountNumberLabel', { defaultValue: 'Số tài khoản' })}</span>
              </label>
              <div className="bam-input-wrapper">
                <Hash size={16} className="bam-input-icon" />
                <input
                  ...
                  >
                    <div className="bam-account-top">
                      <div className="bam-bank-info">
                        <div className="bam-bank-icon-box">
                          <Banknote size={18} />
                        </div>
