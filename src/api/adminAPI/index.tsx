...
export const adminAPI = {
  ...
  getReports: adminGetAPI.getReports,
  getReportDetail: adminGetAPI.getReportDetail,
  ...
  updateReportStatus: adminPutAPI.updateReportStatus,
  resolveReport: adminPutAPI.resolveReport,
