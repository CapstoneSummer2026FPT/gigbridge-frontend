...
export interface AccountReportItem { id: string; reporterId: string; reporterName: string; reportedUserId: string; reportedUserName: string; type: number; status: number; reason: string; createdAt: string; evidenceCount: number; accountStatus: AccountStatus; violationCount: number; isFlagged: boolean; suspendedUntil?: string; assignedAdminId?: string; assignedAdminName?: string }
